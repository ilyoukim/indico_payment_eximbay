...
package_about = {}
with open(os.path.join(repo_base_dir, "indico_payment_eximbay", "__about__.py")) as about_file:
...
setup(
    ...
    entry_points={
        'indico.plugins': {
            'payment_eximbay = indico_payment_eximbay.plugin:EximbayPaymentPlugin'
        }
    },
    packages=find_packages(),
    package_data={'indico_payment_eximbay': ['templates/*.html','static/images/*.png']},
    ...
    zip_safe=False,
    keywords='indico epayment exim eximbay plugin',
)
